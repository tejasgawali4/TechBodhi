package cj46.tejas.com.techbodhi.Utility;
...
public class Config
{
    ...
    public static final String URL_UPDATE_USERINFO="http://platformx.co.in/tbAndroidApp/UpdateUserProfile.php?uid=";
    public static final String URL_VIEW_APPLIED_JOBS="http://platformx.co.in/tbAndroidApp/ViewAppliedJobs.php?uid=";
...
/*
    ...
    public static final String URL_VIEW_APPLIED_JOBS="http://192.168.1.4/TBS_PORTAL/API/ViewAppliedJobs.php?uid=";
