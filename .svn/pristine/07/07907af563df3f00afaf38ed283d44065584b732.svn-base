...
public class AdminPanelEditUser extends AppCompatActivity {
    ...
    public AdminPanelEditUser CustomViewUser = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(AdminPanelEditUser.this);

        CustomListUserViewArray = new ArrayList<>();

        res = getResources();

        UserListView= (ListView) findViewById(R.id.admin_edit_list_user);
        ...
        new AdminPanelEditUser.EditUserDetails().execute();
    }
    ...
    protected class EditUserDetails extends AsyncTask<Void, Void, Void> {
