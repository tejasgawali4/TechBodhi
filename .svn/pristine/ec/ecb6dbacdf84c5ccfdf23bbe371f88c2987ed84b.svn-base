...
import cj46.tejas.com.techbodhi.ApproveUsers;
import cj46.tejas.com.techbodhi.HttpConnection;
...
//            System.out.println("In MyListAdapter ... getView()....FirstName--> "+holder.firstname.getText() +" LastName -->" +holder.lastname.getText() );
        ...
        if (data.size() <= 0)
        {
            ...
            Toast.makeText(activity.getApplicationContext(),"No more users for Approval" , Toast.LENGTH_SHORT).show();
...
/*            holder.uid.setText( tempValues1.getUid() );
        ...
        holder.lastname.setText(tempValues1.get("u_lastname").toString());
        holder.address.setText(tempValues1.get("u_address").toString());
        holder.dob.setText(tempValues1.get("u_dob").toString());
        holder.gender.setText(tempValues1.get("u_gender").toString());
        holder.contact.setText(tempValues1.get("u_contact").toString());
        holder.email.setText(tempValues1.get("u_email").toString());
        holder.username.setText(tempValues1.get("u_username").toString());
