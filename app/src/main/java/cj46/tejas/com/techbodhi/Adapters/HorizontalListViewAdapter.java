...
import cj46.tejas.com.techbodhi.ItemClickListener;
import cj46.tejas.com.techbodhi.MainActivity;
import cj46.tejas.com.techbodhi.R;

/**
  Created by Carl_johnson on 3/3/2017.
 **/
...
public class HorizontalListViewAdapter extends RecyclerView.Adapter<HorizontalListViewAdapter.ViewHolder> {
    ...
    public HorizontalListViewAdapter(Context context, ArrayList<String> alName, ArrayList<Integer> alImage) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.grid_layout_horizontal, viewGroup, false);
