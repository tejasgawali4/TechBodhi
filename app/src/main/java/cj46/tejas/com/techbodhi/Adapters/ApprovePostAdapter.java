...
import cj46.tejas.com.techbodhi.ApprovePosts;
import cj46.tejas.com.techbodhi.HttpConnection;
import cj46.tejas.com.techbodhi.MainActivity;
...
//            System.out.println("In MyListAdapter ... getView()....FirstName--> "+holder.firstname.getText() +" LastName -->" +holder.lastname.getText() );
        ...
        if (data.size() <= 0)
        {
            ...
            Toast.makeText(activity.getApplicationContext(),"No more jobs for Approval" , Toast.LENGTH_SHORT).show();
            ...
            protected void onPostExecute(String s)
            {
                ...
                try {
                    ...
                    if (name.equals("success")) {
                        Toast.makeText(activity.getApplicationContext(), "Post is Approved Successfully", Toast.LENGTH_SHORT).show();
        ...
        class RejectU extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s)
            {
                ...
                try {
                    ...
                    if (name.equals("success"))
                    {
                        Toast.makeText(activity.getApplicationContext(), "Post is Rejected Successfully", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(activity.getApplicationContext(), ApprovePosts.class);
                        activity.startActivity(intent);
