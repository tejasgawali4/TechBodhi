...
import cj46.tejas.com.techbodhi.AdminEditUserProfile;
import cj46.tejas.com.techbodhi.AdminPanelViewUserDetails;
...
public class AdminPanelViewUserAdapter extends BaseAdapter {
    ...
    {
        Intent i = new Intent(activity.getApplicationContext(), AdminEditUserProfile.class );
